...
object BookyIcons {
    ...
    val stats: ImageVector @Composable get() = ImageVector.vectorResource(R.drawable.ms_leaderboard)
    val statsFilled: ImageVector @Composable get() = ImageVector.vectorResource(R.drawable.ms_leaderboard_fill)
    val settings: ImageVector @Composable get() = ImageVector.vectorResource(R.drawable.ms_settings)
    val settingsFilled: ImageVector @Composable get() = ImageVector.vectorResource(R.drawable.ms_settings_fill)
    ...
    val archive: ImageVector @Composable get() = ImageVector.vectorResource(R.drawable.ms_archive)
